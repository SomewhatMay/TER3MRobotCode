...
/*
	AUTHORS: Umayeer Ahsan, Jared Musselman, Jack Siegel.

	DESCRIPTION:
		Commands to control the robot and its various subsystems.
		Programmed for the VEX EDR ClawBot Robot in the TER3M course.
*/

/* Symbolic Constants */
#define DRIVE_TRAIN_SPEED 50
#define DRIVE_TRAIN_MULTIPLIER 0.83 // Linearly adjusts drivetrain delay - to fix voltage reduction from battery drain
#define MOTOR_COMPENSATION 1.095 // Applied to left motor to fix drivetrain asymmetry
#define DRIVE_TRAIN_ANGLE 0 // Faces north at startup
#define TURN_RATIO 600 // A constant that represents how long the robot should yield to make a turn based on driveTrainSpeed
...
/*
	Move the robot 10cm forward, interact with 
	the object, and move 10cm back to the 
	original position.
